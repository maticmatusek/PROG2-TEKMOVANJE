...
public class Vodja {
	...
	public static void dodaj_figuro(int x, int y, Igra igra) {
		...
		if (igra.vrsta_igre.equals("RR")) {
			...
			if (igra.igralec_na_vrsti == igra.racunalnik && igra.skupine_beli.size() == 0
					&& igra.skupine_crni.size() == 0) {
				...
				if (igra.igralec_na_vrsti.equals("Beli"))
					igra.igralec_na_vrsti = "Crni";
				else
					igra.igralec_na_vrsti = "Beli";
				igra.preveri_skupine();
